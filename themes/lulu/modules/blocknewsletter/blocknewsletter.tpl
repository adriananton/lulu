...
<div class="col-xs-4 text-center"><h4>Experienta</h4>
	<div class="type-text">
		<h5><a href="#">Despre Lulu</a></h5>
	</div>
	<div class="type-text">
		<h5><a href="#">Atelierul nostru</a></h5>
	</div>
	<div class="type-text">
		<h5><a href="#">Vouchere cadou</a></h5>
	</div>
</div>
<div class="col-xs-4 text-center"><h4>Informatii</h4>
	<div class="type-text">
		<h5><a href="#">Contact</a></h5>
	</div>
	<div class="type-text">
		<h5><a href="#">Tabel de marimi</a></h5>
	</div>
	<div class="type-text">
		<h5><a href="#">Plata si livrare</a></h5>
	</div>
	<div class="type-text">
		<h5><a href="#">Termeni si conditii</a></h5>
	</div>
</div>
